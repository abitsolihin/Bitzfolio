...
const Navbar = () => {
    ...
    return (
        <header>
            <nav className={(navbarOpen ? "fixed z-10 flex flex-wrap items-center justify-between px-3 md:px-[120px] py-2 bg-[#221B1A] left-0 right-0 top-0 bottom-0" : "fixed z-10 flex flex-wrap items-center justify-between px-3 md:px-[120px] py-2 bg-transparent w-full ") + (colorChange ? "bg-[#221b1a]" : "bg-[#221b1a]/0")} >
                <div className="container px-4 lg:px-0 mx-auto flex flex-wrap md:flex-none items-center justify-between gap-4">
                    <div className="w-full relative flex justify-start lg:w-auto lg:static lg:flex lg:items-center lg:justify-start">
                        ...
                        <button
                            className="text-white absolute right-1 h-full cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-transparent rounded bg-transparent block lg:hidden outline-none focus:outline-none"
                            type="button"
                    ...
                    <div className={(navbarOpen ? "lg:flex flex-grow items-center justify-start md:flex-1 duration-200 opacity-100 h-[160px]" :
                        "lg:flex flex-grow items-center justify-start md:flex-1 hidden lg:opacity-100 h-0")}
                        id="example-navbar-danger">
                        <ul className="flex flex-col lg:flex-row list-none  text-white gap-2 lg:gap-8 lg:ml-auto py-3 lg:mr-5">

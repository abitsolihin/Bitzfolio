  ...
  return (
    <main className='w-full h-screen flex items-center justify-center px-[170px] pt-20 relative'>
      ...
      <div className="container w-full  h-[90%] flex flex-col gap-4">
        <div className="content__project border-2 rounded-2xl px-10 h-full bg-[#221b1a] overflow-hidden flex flex-1">
            <div className="left__content w-full flex flex-col justify-center">
                <article>
                    <h1 className='text-white text-4xl font-bold'>{projects.title}</h1>
                    <h2 className='text-white text-sm mt-1'>{projects.kategori}</h2>
                    <p className='text-gray-400 text-base mt-1'>{projects.deskripsi}</p>

      ...
      <section id='home' data-aos="fade-up" className="flex relative flex-col lg:flex-row-reverse h-full lg:h-[80vh] px-5 lg:px-[120px]">
        ...
        <div className="left h-[40%] lg:h-full lg:w-3/6 lg:flex lg:justify-center">
          <div className="image relative flex items-center justify-center">
            <img data-aos="fade-in" className="w-[200px] lg:w-[70%]" src={profile} alt="Abit Solihin" loading="lazy" />
            ...
            <img className="absolute -top-20 -rotate-12 -right-12 -z-10 hidden lg:flex" src={bgblur} alt="bgblur" loading='lazy' />
            <img className="absolute -bottom-12 -left-32 -z-10 blur-2xl hidden lg:-bottom-48 lg:-left-32 lg:w-[400px] lg:flex" src={bgblur2} alt="bg-blur" loading='lazy' />
          </div>
        </div>
